...
You are running agent-orchestrator v1.6.2. If a session-start hook reports a different installed version, announce the mismatch to the user before doing anything else.
